...
<head>
    ...
    <title>Travel Connect - Dashboard</title>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('../img/index-bg.jpg'); /* Use a relevant image */
...
<body>
    ...
    <main>
        ...
        <p>Discover amazing homestays and nearby attractions</p>
        <div class="cta-buttons">
            <a href="explore.jsp">Explore Homestays</a>
            <a href="attractions.jsp">Discover Attractions</a>
        </div>
    </main>
